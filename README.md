# Hello, Stripe! with Python3 and Flask

This is a simple setup to run a server that makes a charge to Stripe.

The following notes original come from my [documentation website](https://docs.dennisokeeffe.com/manual-stripe-flask-stripe-configuration)
